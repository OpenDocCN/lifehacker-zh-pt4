...
我发现最关键的尺寸是包的长度。没有什么比一个包太长挂在背后或者太短装不下你想要的所有东西更尴尬的了！如果你真的改变了我的包的长度设计，也考虑调整宽度来匹配，这样你就能保持舒适的比例。
...
[Open *imgur.com*](http://imgur.com/a/Eu99V/embed)
