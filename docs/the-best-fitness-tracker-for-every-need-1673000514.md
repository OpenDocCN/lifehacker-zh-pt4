...
如果你想增加一点情趣，这款产品还有四种不同的颜色。里面的可更换硬币电池应该可以用整整六个月，是同类最好的。如果你双击它，它会显示一天中的时间。这是一个简单的设备，但对于 50 美元来说，它相当坚固。
...
250 美元的 Fitbit Surge 是一款非常棒的健身追踪器。它和 Charge HR 一样好。遗憾的是，它真的没有比*更好的*——它实际上无法兼得你的智能手表——而且它多花了 100 美元。
